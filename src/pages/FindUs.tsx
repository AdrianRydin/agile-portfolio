...
function FindUs() {
  return (
    <div className="wrapper">
      <div className="bg-main-blue flex flex-col justify-start items-center h-auto w-full lg:items-start">
        <p className="lg:text-left title text-white text-center md:pl-10">
          FIND US
        </p>
        ...
        <p className="lg:text-left color-main-green small-text pb-8 text-center md:pl-10">
          Our opening hours are 8-17. Monday through Friday.
        </p>
